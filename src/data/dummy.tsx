...
export const gridOrderImage = ({ ProductImage} : Props) => (
  <div>
    <img
...
export const gridOrderStatus = ({StatusBg, Status}: Props) => (
  <button
    type="button"
...
const gridEmployeeProfile = (props: Props) => (
...
const gridEmployeeCountry = (props: Props) => (
...
const customerGridImage = (props: Props) => (
...
const customerGridStatus = (props: Props) => (
